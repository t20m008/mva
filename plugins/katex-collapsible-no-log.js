...
const CollectionName = 'log_20220113'
...
async function katexCollapsibleNoLog(collapse = true, reshape = true, katex_status) {
  // console.log(
...
export default (context, inject) => {
  inject('katexCollapsibleNoLog', katexCollapsibleNoLog)
}
