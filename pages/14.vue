  ...
  <v-row justify="center" class="index">
      ...
      <v-parallax dark height="200" src="https://beiz.jp/images_P/green/green_00010.jpg">
        <v-row align="center" justify="center">
          <v-col class="text-center" cols="10">
            ...
            <h4 v-katex class="subheading">L14 自己回帰モデル $ \mathrm{AR}(m) $, 移動平均モデル $ \mathrm{MA}(k) $</h4>
            <h4></h4>
          </v-col>
        </v-row>
      </v-parallax>
    ...
    <v-col v-katex cols="10" class="">
      ...
      <v-list dense>
        <v-list-item-group>
          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title>確率過程のひとつである自己回帰モデル $ \mathrm{AR}(m) $ を説明できる.</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
          <v-list-item>
            <v-list-item-icon>
      ...
      <v-alert
        ...
        border="left"
        elevation="2"
        ><b>1次の自己回帰モデル $ \mathrm{AR}(1) $ auto regression</b>
      </v-alert>
      ...
      <v-row class="center">
        <v-col cols="10" class="pa-0 ma-0">
          <v-card color="light-blue lighten-5" class="my-4 vcard">
            <v-sheet color="light-blue darken-3">
              <v-card-title color="" class="py-1 pl-3 white--text">1次の自己回帰モデル $ \mathrm{AR}(1) $</v-card-title>
            </v-sheet>
            <v-card-text>
              <ul>
      ...
      $ x_t=\phi_1^t X_0 + \sum_{k=0}^{t-1} \phi_1^k \epsilon_{t-k} $ は, $ |\phi_1| \leq1 $ なら $ t \rightarrow + \infty $
      で定常になる望みがある.
      ...
      \epsilon_{t-k}]\\ &=\mathrm{V}[\phi_1^t X_0] + \sum_{k=0}^{t-1} \phi_1^k \mathrm{V}[\epsilon_{t-k}]\\
      &=\phi_1^t\mathrm{V}[X_0] + \sum_{k=0}^{t-1} \phi_1^k \sigma^2\\ &=\phi_1^t\mathrm{V}[X_0] + \frac{1-\phi_1^t}{1-\phi_1}
      \sigma^2 \end{aligned} \]
      ...
      <p class="mb-15">
        展開すると 0 にならないのは, \(\mathrm{E}[X_0X_0]\), \(\mathrm{E}[\epsilon_k \epsilon_k]=\sigma^2\)のみ.
      </p>
      ...
      <v-row class="center">
        <v-col cols="10" class="pa-0 ma-0">
          <v-card color="light-blue lighten-5" class="my-4">
            <v-sheet color="light-blue darken-3">
              <v-card-title color="" class="py-1 pl-3 white--text">$k$ 次の自己回帰モデル $ \mathrm{MA}(k) $</v-card-title>
            </v-sheet>
            <v-card-text>
              <ul>
                <li>\(\{\epsilon_t\}_{t=1,\ldots,}\): 連続型確率変数の列</li>
      ...
      <v-alert
        ...
        elevation="2"
      >
        <b>移動平均モデル $ \mathrm{MA}(k) $ の母平均値・母共分散</b>
      </v-alert>
